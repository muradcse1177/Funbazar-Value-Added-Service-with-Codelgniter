...
<body class="fixed-top">
    <div id="container" class="row-fluid">
        <div id="sidebar" class="nav-collapse collapse">
            ...
            <ul class="sidebar-menu">
                <li class="has-sub"><a href="javascript:;" class=""><span class="icon-box"><i class="icon-dashboard"></i></span> Upload Content <span class="arrow"></span></a>
                    <ul class="sub">
                        <li class=""><a class="" href="login">Dashboard</a></li>
                    </ul>
                </li>
                <li class="has-sub active"><a href="javascript:;" class=""><span class="icon-box"><i class="icon-picture"></i></span> Contents <span class="arrow"></span></a>
                    <ul class="sub">
                        <li><a class="active" href="login"><i class="icon-upload"></i> Upload</a></li>
        ...
        <div id="main-content">
            <div class="container-fluid">
				...
				<div class="widget-body form">
					<form action="upload_content/upload" method="POST" enctype="multipart/form-data" class="form-horizontal"> 
						<div class="controls">
							<p style="color:green;"><b><?php if(isset($uploadresult)){echo $uploadresult;};?></b></p> 
						</div>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>admin/js/jquery.pulsate.min.js"></script>
    <script src="./assets/fancybox/source/jquery.fancybox.pack.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>admin/assets/jslider/js/jshashtable-2.1_src.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>admin/assets/jslider/js/jquery.numberformatter-1.2.3.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>admin/assets/jslider/js/tmpl.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>admin/assets/jslider/js/jquery.dependClass-0.1.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>admin/assets/jslider/js/draggable-0.1.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>admin/assets/jslider/js/jquery.slider.js"></script>
